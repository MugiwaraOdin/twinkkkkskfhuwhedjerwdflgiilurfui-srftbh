...
export default function Header() {
  return (
    <header className="bg-black text-white py-4 px-4 sm:px-6 md:px-16 flex justify-between items-center sticky top-0 z-50 relative shadow-md gradient-border-b">
      {/* Logo and site name */}
